...
<?php if (count((array)$this->_aVars['aTags'])):  foreach ((array) $this->_aVars['aTags'] as $this->_aVars['aTag']): ?>
        <a href="#" onclick="clickTag('<?php echo $this->_aVars['aTag']['key']; ?>');" title="<?php echo Phpfox::getLib('phpfox.parse.output')->clean(Phpfox::getLib('phpfox.parse.output')->parse($this->_aVars['aTag']['key'])); ?>"><?php echo $this->_aVars['aTag']['key']; ?></a>  
<?php endforeach; endif; ?>
</div>

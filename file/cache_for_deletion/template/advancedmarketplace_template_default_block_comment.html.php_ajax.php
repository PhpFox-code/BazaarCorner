...
<?php /* Cached: February 25, 2013, 5:25 am */  if (Phpfox ::getParam('like.show_user_photos')): ?>
...
<?php if (isset ( $this->_aVars['sFeedType'] ) && $this->_aVars['sFeedType'] == 'view' && $this->_aVars['aFeed']['total_comment'] > $this->_aVars['aFeed']['comment_display']): ?>
...
<?php endif; ?>
			<div class="js_feed_comment_view_more" id="js_feed_comment_view_more_<?php echo $this->_aVars['aFeed']['feed_id']; ?>">
...
<?php if (! isset ( $this->_aVars['aFeed']['no_textarea'] )): ?>
...
<?php endif; ?>
					...
					<div class="feed_comment_buttons_wrap" style="display:block;">
                        ...
                        <div style="width:98%" class="js_feed_add_comment_button t_right">
                            <input type="submit" value="<?php echo Phpfox::getPhrase('feed.comment'); ?>" class="button" />									
                            <input id="close-btn" type="button" value="<?php echo Phpfox::getPhrase('core.close'); ?>" class="button" />									
						</div>
					</div>			

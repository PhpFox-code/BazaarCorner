...
<?php if (count ( $this->_aVars['aTags'] )): ?>
	<div style="width:95%;">
<?php if (count((array)$this->_aVars['aTags'])):  foreach ((array) $this->_aVars['aTags'] as $this->_aVars['aTag']): ?>
			<a href="<?php echo $this->_aVars['aTag']['link']; ?>" style="font-size:<?php echo $this->_aVars['aTag']['value']; ?>px;" title="<?php echo Phpfox::getLib('phpfox.parse.output')->clean(Phpfox::getLib('phpfox.parse.output')->parse($this->_aVars['aTag']['key'])); ?>"><?php echo $this->_aVars['aTag']['key']; ?></a>  
<?php endforeach; endif; ?>
	</div>
<?php else: ?>

...
<?php if (! defined ( 'PHPFOX_PAGER_FORCE_COUNT' )): ?>
	<div class="pager_links_holder">
		...
		<span class="extra_info"><?php echo number_format($this->_aVars['aPager']['fromRow']); ?>-<?php echo number_format($this->_aVars['aPager']['toRow']); ?> of <?php echo number_format($this->_aVars['aPager']['totalRows']); ?> Results</span>
	</div>
<?php else: ?>

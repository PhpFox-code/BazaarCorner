...
<?php if (count((array)$this->_aVars['aTodayListing'])):  foreach ((array) $this->_aVars['aTodayListing'] as $this->_aVars['iKey'] => $this->_aVars['aListing']): ?>
    <div class="view_content_listing">
        <div class="row_listing_image">
			<a href="<?php echo $this->_aVars['aListing']['url']; ?>" title="<?php echo Phpfox::getLib('phpfox.parse.output')->parse(Phpfox::getLib('phpfox.parse.output')->clean($this->_aVars['aListing']['title'])); ?>"><?php if ($this->_aVars['aListing']['image_path'] != NULL): ?><img title="<?php echo $this->_aVars['aListing']['title']; ?>" src="<?php echo $this->_aVars['advancedmarketplace_url_image'] . PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aListing"]["image_path"], "_120"); ?>" max_width='120' max_height='120' /><?php else: ?><img title="<?php echo $this->_aVars['aListing']['title']; ?>" src="<?php echo $this->_aVars['corepath']; ?>module/advancedmarketplace/static/image/default/noimage.png" max_width='120' max_height='120' /><?php endif; ?></a>
        </div>

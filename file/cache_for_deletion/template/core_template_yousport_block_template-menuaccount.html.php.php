...
<ul>
        <li>
                <a href="#" class="has_drop_down"><span><?php echo Phpfox::getPhrase('pages.account'); ?></span></a>
                <ul>
...
<?php echo Phpfox::getLib('phpfox.parse.output')->shorten(Phpfox::getLib('phpfox.parse.output')->split('<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aGlobalUser']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aGlobalUser']['user_name'], ((empty($this->_aVars['aGlobalUser']['user_name']) && isset($this->_aVars['aGlobalUser']['profile_page_id'])) ? $this->_aVars['aGlobalUser']['profile_page_id'] : null))) . '">' . Phpfox::getLib('phpfox.parse.output')->shorten($this->_aVars['aGlobalUser']['full_name'], Phpfox::getParam('user.maximum_length_for_full_name')) . '</a></span>', 10), 20, '...'); ?>
                                </div>
                        </li>		
...
<?php if (count((array)$this->_aVars['aRightMenus'])):  foreach ((array) $this->_aVars['aRightMenus'] as $this->_aVars['iKey'] => $this->_aVars['aMenu']): ?>
        <li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aMenu']['url']); ?>"<?php if (isset ( $this->_aVars['aMenu']['children'] ) && count ( $this->_aVars['aMenu']['children'] ) && is_array ( $this->_aVars['aMenu']['children'] )): ?> class="has_drop_down no_ajax_link"<?php endif; ?>><span><?php echo Phpfox::getPhrase($this->_aVars['aMenu']['module'].'.'.$this->_aVars['aMenu']['var_name']);  if (isset ( $this->_aVars['aMenu']['suffix'] )):  echo $this->_aVars['aMenu']['suffix'];  endif; ?></span> </a>					
...
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('user' => $this->_aVars['aGlobalUser'],'suffix' => '_50_square','max_width' => 50,'max_height' => 50)); ?>
                                ...
                                <div id="header_menu_user_profile">
<?php echo '<span class="user_profile_link_span" id="js_user_name_link_' . $this->_aVars['aGlobalUser']['user_name'] . '"><a href="' . Phpfox::getLib('phpfox.url')->makeUrl('profile', array($this->_aVars['aGlobalUser']['user_name'], ((empty($this->_aVars['aGlobalUser']['user_name']) && isset($this->_aVars['aGlobalUser']['profile_page_id'])) ? $this->_aVars['aGlobalUser']['profile_page_id'] : null))) . '">' . Phpfox::getLib('phpfox.parse.output')->shorten($this->_aVars['aGlobalUser']['full_name'], Phpfox::getParam('user.maximum_length_for_full_name')) . '</a></span>'; ?>
                                </div>
                        </li>
...
<?php endforeach; endif;  unset($this->_aVars['aRightMenus'], $this->_aVars['aMenu']); ?>
</ul>
<?php endif; ?>

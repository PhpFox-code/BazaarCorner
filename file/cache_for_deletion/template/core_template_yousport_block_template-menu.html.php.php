...
<?php if (count((array)$this->_aVars['aMenus'])):  $this->_aPhpfoxVars['iteration']['menu'] = 0;  foreach ((array) $this->_aVars['aMenus'] as $this->_aVars['iKey'] => $this->_aVars['aMenu']):  $this->_aPhpfoxVars['iteration']['menu']++; ?>
								...
								<li <?php if (( $this->_aVars['aMenu']['url'] == 'apps' && count ( $this->_aVars['aInstalledApps'] ) ) || ( isset ( $this->_aVars['aMenu']['children'] ) && count ( $this->_aVars['aMenu']['children'] ) )): ?>class="explore"<?php endif; ?>><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aMenu']['url']); ?>" class="<?php if (isset ( $this->_aVars['aMenu']['external'] ) && $this->_aVars['aMenu']['external'] == true): ?>no_ajax_link <?php endif; ?>ajax_link">

...
<?php /* Cached: February 25, 2013, 5:26 am */ ?>
 ...
 */
 if ($this->_aVars['aInterestedListing'] !== NULL):  echo '
<style type="text/css">
...
<?php if (count((array)$this->_aVars['aInterestedListing'])):  foreach ((array) $this->_aVars['aInterestedListing'] as $this->_aVars['iKey'] => $this->_aVars['aListing']): ?>
    <div class="view_content_listing">
        ...
        <div class="row_title_info">
            <a class="advlink" href="<?php echo $this->_aVars['aListing']['url']; ?>"><?php echo Phpfox::getLib('phpfox.parse.output')->split(Phpfox::getLib('phpfox.parse.output')->shorten($this->_aVars['aListing']['title'], 50, '...'), 25); ?></a>
...
<?php endif; ?>
    ...
    <div class="clear"></div>
<?php endforeach; endif; ?>
<?php if ($this->_aVars['bIsViewMore']): ?><div class="view_more_link"><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('advancedmarketplace.search', array('seller-more' => $this->_aVars['aListing']['listing_id'])); ?>"><?php echo Phpfox::getPhrase('advancedmarketplace.view_more'); ?></a></div><?php endif; ?>
</div>
<?php endif; ?>

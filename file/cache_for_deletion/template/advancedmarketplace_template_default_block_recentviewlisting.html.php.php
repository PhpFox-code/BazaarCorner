 ...
 */
 if ($this->_aVars['aRecentViewListing'] !== NULL):  echo '
<style type="text/css">
...
<?php if (count((array)$this->_aVars['aRecentViewListing'])):  foreach ((array) $this->_aVars['aRecentViewListing'] as $this->_aVars['iKey'] => $this->_aVars['aListing']): ?>
...
<?php endif; ?>
    ...
    <div class="clear"></div>
<?php endforeach; endif; ?>
<?php if ($this->_aVars['bIsViewMore']): ?><div class="view_more_link"><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('advancedmarketplace.search.sort_recent-viewed'); ?>"  title="<?php echo Phpfox::getPhrase('advancedmarketplace.view_more'); ?>"><?php echo Phpfox::getPhrase('advancedmarketplace.view_more'); ?></a></div><?php endif; ?>
</div>
<?php endif; ?>

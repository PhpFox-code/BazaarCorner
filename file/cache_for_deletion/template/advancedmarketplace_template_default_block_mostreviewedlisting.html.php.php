...
<?php if (count((array)$this->_aVars['aReviewedListings'])):  foreach ((array) $this->_aVars['aReviewedListings'] as $this->_aVars['iKey'] => $this->_aVars['aListing']): ?>
    <div class="view_content_listing">
        <div class="row_listing_image">
			<a href="<?php echo $this->_aVars['aListing']['url']; ?>" title="<?php echo Phpfox::getLib('phpfox.parse.output')->clean(Phpfox::getLib('phpfox.parse.output')->parse($this->_aVars['aListing']['title'])); ?>"><?php if ($this->_aVars['aListing']['image_path'] != NULL): ?><img title="<?php echo $this->_aVars['aListing']['title']; ?>" src="<?php echo $this->_aVars['advancedmarketplace_url_image'] . PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aListing"]["image_path"], "_120"); ?>" max_width='120' max_height='120' /><?php else: ?><img title="<?php echo $this->_aVars['aListing']['title']; ?>" src="<?php echo $this->_aVars['corepath']; ?>module/advancedmarketplace/static/image/default/noimage.png" max_width='120' max_height='120' /><?php endif; ?></a>
        </div>
...
<?php } ?>
				...
				<div>
<?php echo Phpfox::getPhrase("advancedmarketplace.nreview_review_s", array('nreview' => $this->_aVars['aListing']['rating_count'])); ?>
				</div>
			</div>
        </div>
    </div>
    <div class="clear"></div>
<?php endforeach; endif; ?>
<?php if ($this->_aVars['bIsViewMore']): ?><div class="view_more_link"><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('advancedmarketplace.search.sort_most-reviewed'); ?>"><?php echo Phpfox::getPhrase('advancedmarketplace.view_more'); ?></a></div><?php endif; ?>

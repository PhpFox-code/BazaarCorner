...
<?php /* Cached: February 25, 2013, 5:14 am */ ?>
<?php 
...
<?php echo Phpfox::getPhrase('advancedmarketplace.sponsored'); ?>
						...
						<a href="<?php echo $this->_aVars['aListing']['url']; ?>"><?php if ($this->_aVars['aListing']['image_path'] != NULL): ?><img title="<?php echo $this->_aVars['aListing']['title']; ?>" src="<?php echo $this->_aVars['advancedmarketplace_url_image'] . PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aListing"]["image_path"], "_120"); ?>" style="max-width: 120px; max-height: 90px;" max-width='120' max-height='90' /><?php else: ?><img title="<?php echo $this->_aVars['aListing']['title']; ?>" src="<?php echo $this->_aVars['corepath']; ?>module/advancedmarketplace/static/image/default/noimage.png" style="max-width:120px; max-height:90px" max-width='120' max-height='90' /><?php endif; ?></a>

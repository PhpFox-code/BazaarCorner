...
<?php /* Cached: August 17, 2013, 5:54 pm */ ?>
...
<?php echo $this->getHeader(); ?>
	...
	<body class="<?php echo $this->_aVars['spage']; ?>">
			...
			<div id="header_menu_page_holder">	
				<div class="holder">
                    ...
                    <div style="float:left; width:331px; height:133px; ">
						<a href="http://localhost/bazaarcorner/index.php?do=/#_=_">
...
<strong style="color:#E117B8; font-size:16px;">Hi</strong> <span style="color:#FFF;font-size:16px;"><?php echo $this->_aVars['sGlobalUserFullName']; ?>!</span>
</center>
...
<?php if (!$this->bIsSample):  $this->getLayout('error');  endif; ?>
												<div class="<?php if (isset ( $this->_aVars['spage'] ) && $this->_aVars['spage'] == 'visitor index'): ?>younetblog<?php endif; ?>">												
...
<?php if (!$this->bIsSample): ?><div id="site_content"><?php if (isset($this->_aVars['bSearchFailed'])): ?><div class="message">Unable to find anything with your search criteria.</div><?php else:  Phpfox::getLib('phpfox.module')->getControllerTemplate();  endif; ?></div><?php endif; ?>
                                                                                        <div class="<?php if (isset ( $this->_aVars['spage'] ) && $this->_aVars['spage'] == 'visitor index'): ?>younetevent<?php endif; ?>">

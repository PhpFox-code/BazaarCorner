...
We strongly recommend that you use level 1 for optimum results.</info>',
  ...
  'setting_site_title' => '<title>BazaarCorner</title><info>Name of your site. This will appear on every page.</info>',
...
<b>Note:</b> Set to <b>0</b> to have no limit.</info>',
  ...
  'setting_footer_bar_site_name' => '<title>BazaarCorner</title><info>The name defined here will be displayed on the sites footer bar.</info>',
...
If you set it to zero ("0" without quotes) it will hide every subcategory and a plus sign will show next to the category name, clicking the plus sign will show that category\'s subcategories.
  ...
  'u_s_dollars' => 'U.S. Dollar',
  'euros' => 'Philippines Peso',
...
If you disable it extra checks will be added to try to preserve the original name of the file. If an item with the same name already exists the new one will have a number added at the end.</info>',
  ...
  'error' => 'Error',
  'custom_currency_sgd' => 'Singapore Dollar',
  'custom_currency_gbp' => 'British Pounds',
); ?>
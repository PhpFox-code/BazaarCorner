...
(function($){
	$.fn.etalage = function(options){
		...
		var o = $.extend({
			...
			thumb_image_width: 255,				// The large thumbnail width (excluding borders / padding) (value in pixels)
			thumb_image_height: 340,			// The large thumbnail height (excluding borders / padding) (value in pixels)
			source_image_width: 500,			// The source/zoomed image width (not the frame around it) (value in pixels)
			source_image_height: 667,			// The source/zoomed image height (not the frame around it) (value in pixels)
			...
			zoom_area_distance: 8,				// Distance between the zoom area and thumbnail (value in pixels)

<upgrade>
	<phrases>
		...
		<phrase>
			<module_id>advancedmarketplace</module_id>
			<version_id>2.0.0rc11</version_id>
			<var_name>user_setting_can_access_advancedmarketplace</var_name>
	...
	<user_group_settings>
		<setting>
			...
			<ordering>0</ordering>
			<value>can_access_advancedmarketplace</value>
		</setting>
		<setting>
			<is_admin_setting>0</is_admin_setting>
			<module_id>advancedmarketplace</module_id>
	...
	<hooks>
		<hook>
			...
			<module>advancedmarketplace</module>
			<call_name>advancedmarketplace.service_process_add__start</call_name>
		...
		<hook>
			...
			<hook_type>service</hook_type>
			<module>advancedmarketplace</module>
			<call_name>advancedmarketplace.service_process_add__end</call_name>
			<added>1260366442</added>
			<version_id>2.0.0rc11</version_id>
			<value />
		</hook>

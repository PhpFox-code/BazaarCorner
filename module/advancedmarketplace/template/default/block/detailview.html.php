    ...
    <div class="large_listing_image">
		...
		{if $aListing.image_path != NULL}{*
			*}<a title="{$aListing.title}" class="js_marketplace_click_image no_ajax_link" href="{$advancedmarketplace_url_image}<?php echo PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aListing"]["image_path"], "_400"); ?>">
				<img title="{$aListing.title}" src="{$advancedmarketplace_url_image}<?php echo PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aListing"]["image_path"], "_200"); ?>" max_width='180' max_height='180' style="max-width: 180px; max-height: 180px;" />
			</a>{*
		*}{else}{*

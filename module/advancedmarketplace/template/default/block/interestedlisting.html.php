	   ...
	   <div class="view_content_listing">
	        <div class="row_listing_image">
				<a title="{$aListing.title|clean|parse}" href="{$aInterestedListing.url}">{*
					*}{if $aInterestedListing.image_path != NULL}{*
						*}<img title="{$aInterestedListing.title}" src="<?php echo $this->_aVars['advancedmarketplace_url_image'] . PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aInterestedListing"]["image_path"], "_120"); ?>" max_width='120' max_height='120' />{*
					*}{else}{*
	        ...
	        <div class="row_title_info">
	            ...
	            <div class="advancedmarketplace_price_tag">
					...
					{else}
					{$aInterestedListing.currency_id|currency_symbol}{$aInterestedListing.price|number_format:2:',':'.'}
					{/if}
				</div>

		...
		<div id="js_advancedmarketplace_listingdetail_tab" class="">
			<div class="menu">
				<ul id="yn_tab">
					...
					<li class="last"><a id="yn_show_yn_listingrating" href="#">{phrase var='advancedmarketplace.review'} (<span class="review-count">{$iRatingCount}</span>)</a></li>
				</ul>
				<div class="clear"></div>
			</div>
		<div class="">
...
<div class="native-float-div">
	...
	<?php if(phpfox::getParam('advancedmarketplace.can_print_a_listing') == true) {l} ?>

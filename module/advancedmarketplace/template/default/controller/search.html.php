...
<div class="row_title_image_header_body" style="min-height: 160px!important;">				
    ...
    <div class="row_title">				
        ...
        <div class="row_title_info">		
            ...
            {if Phpfox::isMobile()}
            <a href="{$aListing.url}">
                {*img server_id=$aListing.server_id title=$aListing.title path='advancedmarketplace.url_image' file=$aListing.image_path suffix='_120' max_width='120' max_height='120'*}
                <img title="{$aListing.title}" src="{$advancedmarketplace_url_image}<?php echo PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aListing"]["image_path"], "_120"); ?>" max_width='120' max_height='120' />
            </a>
            {/if}

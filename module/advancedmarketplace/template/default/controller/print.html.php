...
<div class="large_listing_image">
	...
	{if $aListing.image_path != NULL}{*
		*}<a class="js_marketplace_click_image no_ajax_link" href="{$advancedmarketplace_url_image}<?php echo PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aListing"]["image_path"], "_400"); ?>">
			<img style="max-width:520px;max-height:322px;" title="{$aListing.title}" src="{$advancedmarketplace_url_image}<?php echo PHPFOX::getService("advancedmarketplace")->proccessImageName($this->_aVars["aListing"]["image_path"], ""); ?>" max_width='520px' max_height='322px' />
		</a>{*
	*}{else}{*

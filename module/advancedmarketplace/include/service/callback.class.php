...
class AdvancedMarketplace_Service_Callback extends Phpfox_Service
{
	...
	public function addComment($aVals, $iUserId = null, $sUserName = null)
	{
		...
		Phpfox::getService('comment.process')->notify(array(
				...
				'owner_subject' => Phpfox::getPhrase('advancedmarketplace.full_name_commented_on_your_listing_title', array('full_name' => Phpfox::getUserBy('full_name'), 'title' => $aRow['title'])),
				'owner_message' => Phpfox::getPhrase('advancedmarketplace.full_name_commented_on_your_listing_a_href_link_title_a_to_see_the_comment_thread_follow_the_link_below_a_href_link_link_a',array('full_name' => Phpfox::getUserBy('full_name'), 'link' => $sLink, 'title' => $aRow['title'])),
...
Phpfox::getPhrase('advancedmarketplace.full_name_commented_on_other_full_name',array('full_name' => Phpfox::getUserBy('full_name'), 'other_full_name' => $aRow['full_name'], 'link' => $sLink, 'title' => $aRow['title']))
	...
	public function getNotificationFeedApproved($aRow)
	{
		return array(
			...
			'path' => 'advancedmarketplace.url_image',
			'suffix' => '_120'
		);
	}
	...
	public function getToSponsorInfo($iId)
	{
	    ...
	    {
			$aListing['image_dir'] = Phpfox::getParam('core.url_pic') . "advancedmarketplace/";
	...
	public function getActivityFeed($aItem, $aCallback = null, $bIsChildItem = false)
	{
		...
		{
			$sImage = Phpfox::getService('advancedmarketplace.helper')->display(array(
					'server_id' => $aRow['server_id'],
					'source' => Phpfox::getParam('core.url_pic') . "advancedmarketplace/" . PHPFOX::getService("advancedmarketplace")->proccessImageName($aRow["image_path"], "_120"),
					'max_width' => 120,
					'max_height' => 120
				)
			);
	...
	public function getSearchInfo($aRow)
	{
		...
		$aInfo['item_display_photo'] = sprintf("<img title=\"%s\" src=\"$advancedmarketplace_url_image%s\" max-width=\"120\" max-height=\"120\" style=\"max-height: 120px; max-width: 120px;\" />", "", PHPFOX::getService("advancedmarketplace")->proccessImageName($aRow['item_photo'], "_120"));
		return $aInfo;
	}

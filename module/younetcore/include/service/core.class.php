...
class YouNetCore_Service_Core extends Younet_Service
{
	/**
	 * Class constructor
	 */
	...
	public function __construct()
	{
		...
		$this->_config = array (
			...
			'cache' => array(
				'sCacheYNModuleName' => array('younetcore', '_cache_module_yn_name'),
				'sCacheModuleName' => array('younetcore', '_cache_module_yours_name'),
				'sCacheInvalidName' => array('younetcore', '_cache_invalid_yours_name'),
				'sCacheYNNews' => array('younetcore', '_cache_younet_news')
			),
	...
	{		
        $this->cache()->remove(array('younetcore', ''), 'substr');
	}
